...
Click **Generate Pairing Code** to create a unique code for this deployment. This code will be used to connect your device with dashboard. You need to paste this code in [Here](./setup-device.mdx#step-8-register-your-device) to complete the device setup.
