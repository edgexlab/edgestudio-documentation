...
![Insert screenshot: device powered on](../Images/Device_setup/part.png)
...
![Setup Page](../Images/Device_setup/part6.png)

**If the page doesn't open automatically, open your browser and type this link `http://192.168.4.1` and you will see the below page.**
...
![Insert screenshot: setup form filled in](../Images/Device_setup/part5.png)
...
![Insert screenshot: connecting/loading screen](../Images/Device_setup/part3.png)
...
![Insert screenshot: success screen with IP address](../Images/Device_setup/part2.png)
...
![Insert screenshot: sign-in page on home wifi](../Images/Device_setup/part1.png)

---

## Step 8: Register Your Device

After signing in, enter your **Device ID** and **Device Token**. You can find both of these on your EdgeStudio dashboard [here](build-deploy.mdx#step-2-generate-a-pairing-code).


![Insert screenshot: device registration form](../Images/Device_setup/part7.png)

Tap **Register Device** to finish. Your device is now fully set up and connected to your EdgeStudio account.

![Insert screenshot: device status page showing "Connected and registered"](../Images/Device_setup/part8.png)
